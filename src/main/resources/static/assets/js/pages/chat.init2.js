...
// userData.id에 따라서 active 설정!!
                var activeClass = userData.id === 0 ? "active" : "";
    ...
    function getMsg(id, msg, has_images, has_files, has_dropDown) {
        ...
        if (has_dropDown === true) {
            msgHTML +=
                ...
                <div class="dropdown-menu">\
                    <a class="dropdown-item reply-message" href="#"><i class="ri-reply-line me-2 text-muted align-bottom"></i>답장</a>\
                    <a class="dropdown-item" href="#"><i class="ri-share-line me-2 text-muted align-bottom"></i>Forward</a>\
                    <a class="dropdown-item copy-message" href="#"><i class="ri-file-copy-line me-2 text-muted align-bottom"></i>복사</a>\
                    <a class="dropdown-item" href="#"><i class="ri-bookmark-line me-2 text-muted align-bottom"></i>책갈피</a>\
                    <a class="dropdown-item delete-item" href="#"><i class="ri-delete-bin-5-line me-2 text-muted align-bottom"></i>삭제</a>\
                </div>\
            </div>'
        }
        msgHTML += '</div>';
